...
\pkey{row}, \pkey{seat\_num} and reserved (which means reserved for disabled
people). Thus, the primary key for the entity Seat is the tuple (\key{cinema\_id},
\pkey{room\_num}, \pkey{row}, \pkey{seat\_num}).
