...
number of the review. We will need to add one or more attributes to the table
ReviewR as well since Review is also a weak entity of another entity in Part 2
(the Film entity). These will be explained more in the table Review part. For
now, the table ReviewR is
\begin{align*}
